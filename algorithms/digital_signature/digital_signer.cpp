...
std::string digital_signer::encrypt(const std::string& message) const
{
	return encrypt(message, _public_key);
}

std::string digital_signer::encrypt(const std::string& message, const std::string& key)
{
...
std::string digital_signer::decrypt(const std::string& message) const
{
...
const std::string& digital_signer::get_public_key() const
{
	return _public_key;
}

void digital_signer::_generate_keys()
{
